$(document).ready(function () { 
    ...
    function graph_op() 
    {
        ...
        fetch(url_base + '/api/bilan_op/' + yearSelect +'/'+ user.magasin_id)
    ...
    function graph_eva_vente() 
    {
        ...
        fetch(url_base + '/api/bilan_eva_vente/' + yearSelect +'/'+ user.magasin_id)
            .then(response => response.json())
            .then(data => {
    ...
    function graph_vente_prevision() {
        ...
        fetch(url_base + '/api/stat_prevision/' + user.magasin_id)
            .then(response => response.json())
            .then(data => {
    ...
    function graph_client() 
    {
        ...
        fetch(url_base + '/api/bilan_client/' + yearSelect +'/'+ user.magasin_id)
            .then(response => response.json())
            .then(data => {
    ...
    function vente_detail()
    {
        ...
        $.ajax({
            url: url_base + '/api/G_bilan_detail_vente/' + periode + '/' + user.magasin_id,
            method: 'GET',
                ...
                stats.forEach(function(stat) {
                    ...
                    const div = $(`
                        <div class="col-xxl-3 col-lg-4 col-sm-6" >
                            <div class="card pricing text-center card_hover">
